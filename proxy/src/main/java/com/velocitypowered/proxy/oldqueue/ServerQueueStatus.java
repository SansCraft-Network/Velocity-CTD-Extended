...
package com.velocitypowered.proxy.oldqueue;
 ...
 */
public class ServerQueueStatus { // Queue
...
//    this.velocityServer.getRedisManager().addOrUpdateQueue(this);
  ...
  public void queue(final UUID playerUuid, final int priority, final boolean fullBypass, final boolean queueBypass) {
    if (!config.isEnabled()) { // dit is bullshit, niet hier checken. eerder checken, en dan normaal senden
