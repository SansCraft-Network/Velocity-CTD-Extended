...
public sealed interface RedisPacket permits AbstractRedisPacket {
  ...
  /**
   * Get the unique if of the {@link com.velocitypowered.proxy.xcd_redis.transaction.Transaction} this
   * packet is part of
   *
  ...
  /**
   * Set the unique id of the {@link com.velocitypowered.proxy.xcd_redis.transaction.Transaction} this
   * packet is part of
   *
  ...
  /**
   * Get the type of the {@link com.velocitypowered.proxy.xcd_redis.transaction.Transaction} this packet is part of
   *
  ...
  /**
   * Set the type of the {@link com.velocitypowered.proxy.xcd_redis.transaction.Transaction} this packet is part of
   *
